...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .btn-submit{width:100%;padding:14px;border-radius:50px;border:none;background:linear-gradient(135deg,#ff6b6b,#ff8e53);color:white;font-size:15px;font-weight:600;font-family:'DM Sans',sans-serif;cursor:pointer;transition:all 0.2s;box-shadow:0 8px 24px rgba(255,107,107,0.3);margin-top:8px;margin-bottom:20px;}
...
<div class="card">
    ...
    <p class="card-sub">Start writing your notes today</p>
    ...
    <div class="link-row">Already have an account? <a href="{{ route('login') }}">Log in</a></div>
</div>
</body>
</html>